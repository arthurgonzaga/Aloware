...
class AppDelegate: UIResponder, UIApplicationDelegate, PKPushRegistryDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        window.rootViewController = AlowareViewController()
        window.backgroundColor = UIColor(.darkBlue ?? .black)
        window.makeKeyAndVisible()
        let viewController = UIApplication.shared.windows.first?.rootViewController as? AlowareViewController
        self.pushKitEventDelegate = viewController as? any PushKitEventDelegate
        self.window = window
        /*
